...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "1st Lady Hair & Beauty Salon — Look Fabulous, Feel Great" },
      { property: "og:description", content: "Premium ladies-only hair, beauty, bridal & spa services in Bagha Purana, Moga. Book an appointment at 1st Lady Hair & Beauty Salon." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "1st Lady Hair & Beauty Salon — Look Fabulous, Feel Great" },
      { name: "twitter:description", content: "Premium ladies-only hair, beauty, bridal & spa services in Bagha Purana, Moga. Book an appointment at 1st Lady Hair & Beauty Salon." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3026daed-f798-4d06-a36b-4fae82c54627/id-preview-e1b5c264--c1fc583e-98e3-4bd2-899f-59e910546379.lovable.app-1786015212298.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/3026daed-f798-4d06-a36b-4fae82c54627/id-preview-e1b5c264--c1fc583e-98e3-4bd2-899f-59e910546379.lovable.app-1786015212298.png" },
    ],
    links: [
